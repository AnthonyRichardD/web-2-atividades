...
<div class="container">
    ...
    <form action="{{ route('books.update', $book) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <img src="{{ $book->cover_image ? asset('storage/' . $book->cover_image) : asset('images/default-cover.png') }}" alt="Capa do Livro" class="img-thumbnail mb-2" style="max-height: 200px;">
            <label for="cover_image" class="form-label">Trocar Capa do Livro</label>
